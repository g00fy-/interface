...
import { useTokenContract, useGenericTokenContract } from '@hooks/contracts/useContract'

import { usePool } from '@hooks/pools/usePools'

import { useSingleCallResult, useMultipleContractSingleData, useSingleContractMultipleMethods } from '@hooks/multicall'
import { ERC20_INTERFACE } from '@constants/interfaces'
import { useGenericMulticall2Contract, useMulticall2Contract } from '@hooks/contracts/useMulticallContract'
/**
 * @param {Token} t
 * @return {BigNumber}
 */
export function useTokenBalance(t) {
  ...
  const singleCallResult = useSingleCallResult(
    ...sharedArgs
  )
